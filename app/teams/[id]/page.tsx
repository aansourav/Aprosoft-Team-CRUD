  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast({
          title: "Error",
          description: data.error || `Failed to update team "${formData.teamName}". Please try again.`,
          variant: "destructive",
        })
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 p-6">
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 animate-slide-in">
          ...
          <p className="mt-2 text-lg text-muted-foreground">Update team details and members</p>
        </div>
